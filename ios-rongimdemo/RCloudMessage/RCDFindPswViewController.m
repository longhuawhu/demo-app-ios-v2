...
- (void)viewDidLoad
{
    ...
    [sendCodeButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    ...
    [reSendCodeButton setTitleColor:[[UIColor alloc]initWithRed:153 green:153 blue:153 alpha:0.5] forState:UIControlStateDisabled];
    [reSendCodeButton setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    reSendCodeButton.titleLabel.font=[UIFont systemFontOfSize:14];
    [reSendCodeButton addTarget:self action:@selector(sendCodeEvent) forControlEvents:UIControlEventTouchUpInside];
    ...
    vCodeTimerLb.textColor=[[UIColor alloc]initWithRed:153 green:153 blue:153 alpha:0.5];
    ...
    UIButton *registerButton= [[UIButton alloc ]initWithFrame:CGRectMake(-10, 0, 80, 50)];
    ...
    NSArray *viewConstraints = [[[[[[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-41-[_inputBackground]-41-|"
                                                                            ...
                                                                            metrics:nil
                                                                              views:views]
                                    arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-14-[_rongLogo]-70-|"
                                                                                                          options:0
                                                                                                          metrics:nil
                                                                                                            views:views]]
                                   arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-70-[_licenseLb(5)]-10-[_rongLogo(60)]-[_errorMsgLb(5)]-[_inputBackground(260)]-100-[bottomBackground(50)]|"
                                                                                                         options:0
                                                                                                         metrics:nil
                                                                                                           views:views]]
