...
- (void)viewDidLoad
{
    ...
    NSArray *viewConstraints = [[[[[[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-41-[_inputBackground]-41-|"
                                                                ...
                                                                arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-14-[_rongLogo]-70-|"
                                                                                                        ...
                                                                                                        metrics:nil
                                                                                                          views:views]]
                                                                arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-70-[_licenseLb(5)]-10-[_rongLogo(60)]-[_errorMsgLb(5)]-[_inputBackground(260)]-1-[userProtocolButton(20)]-100-[bottomBackground(50)]|"
                                                                         options:0
                                                                         metrics:nil
                                                                           views:views]]
    ...
    NSArray *inputViewConstraints = [[[[[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[userNameTextField]|"
                                      ...
                                      [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[rePasswordTextField]|"
                                                                              options:0
                                                                              metrics:nil
